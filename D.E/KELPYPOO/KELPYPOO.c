...
#define KELP_PORT 3
#define KELP_TOP 940
#define KELP_BOTTOM 650
#define KELP_SCORE 1600
#define GRAB_PORT 1
#define GRAB_DOWN 320
#define GRAB_HOLD 1200
...
void align_wall()
{
	create_straight(-MID_SPEED);
	msleep(750L);
	create_drive_segment(LOW_SPEED + 75, 47);
	create_cease();
}
int main()
{
	...
	*/
	...
	create_drive_segment(500,730);//go to the opponent's mpa
